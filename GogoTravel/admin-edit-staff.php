                        ...
                        <div class="col-lg-10 col-md-10">
                            ...
                            <form action="#" method="POST">
                                ...
                                <div class="mt-10">
                                    ...
                                    <input type="text" name="update_name" class="form-control" placeholder="Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Full Name'" required>
                                </div>
                                <br>
                                <div class="mt-10">
                                    <label class="col-md-3">Username:</label>
                                    <input type="text" name="update_username" class="form-control" placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'" required>
                                </div>
                                <br>
                                <div class="mt-10">
                                    <label class="col-md-3">E-mail:</label>
                                    <input type="email" name="update_email" class="form-control" placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'E-mail'" required>
                                </div>
                                <br>
                                <div class="mt-10">
